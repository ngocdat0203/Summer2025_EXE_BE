...
/*
    ...
    public String generateToken(int id, String email, List<RoleName> roles, String fullName, String address, Integer consultantId) {
        ...
        return Jwts.builder()
                ...
                .claim("counsultantId", consultantId)
